...
- 📊 **Google Data Analytics** — Coursera (March 2025)
- 🏆 **Data Analytics Certificate (DAC)** — BrainStation (July 2025)
- 🔍 Currently open to **Data Science** & **ML Engineering** roles
...
### 🏥 Hospital Chatbot
AI-powered assistant for hospital inquiries and appointment scheduling using NLP and intent recognition.

**Tech:** Python · NLP · Flask

[![View](https://img.shields.io/badge/GitHub-View%20Repo-181717?style=flat-square&logo=github)](https://github.com/adam798/hospital-chatbot)

</td>
<td width="50%">

### 💳 Loan Default Prediction
Classification model predicting loan defaulters using decision trees and logistic regression on financial data.

**Tech:** Sklearn · Pandas · ML

[![View](https://img.shields.io/badge/GitHub-View%20Repo-181717?style=flat-square&logo=github)](https://github.com/adam798/loan-default-prediction)
...
NLP pipeline classifying thousands of Amazon reviews into positive, neutral, or negative categories.

**Tech:** NLTK · TextBlob · NLP

[![View](https://img.shields.io/badge/GitHub-View%20Repo-181717?style=flat-square&logo=github)](https://github.com/adam798/Amazon-Customer-Review-Sentiment-Analysis)

</td>
<td width="50%">

### 🏷️ Product Price Prediction
XGBoost regression model predicting kids' product resale prices using brand, condition and item type.

**Tech:** XGBoost · Pandas · Regression

[![View](https://img.shields.io/badge/GitHub-View%20Repo-181717?style=flat-square&logo=github)](https://github.com/adam798/price-prediction)
